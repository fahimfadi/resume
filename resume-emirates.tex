...
\begin{minipage}[t]{0.84\textwidth}  % Adjusted width to fill space
	\begin{center}
		...
		{\small Height: 175 cm \quad | \quad Weight: 68 kg}
	\end{center}
\end{minipage}
...
\begin{itemize}[leftmargin=0.15in, label={}]
	\small{\item{
		Dedicated and customer-focused professional with over 3 years of experience in the hospitality and service industry. Proven ability to deliver world-class service, ensure passenger safety and comfort, and represent Emirates Airlines with professionalism and cultural sensitivity. Skilled in maintaining calm under pressure and exceeding customer expectations.
		}}
\end{itemize}
\section{Education}
...
\resumeItemListStart
\resumeItem{ Delivered outstanding customer service in a high-volume environment, managing 100+ customer interactions daily. }
\resumeItem{ Resolved customer issues efficiently, maintaining a 95\% satisfaction rate.}
\resumeItem{Trained and supervised new employees on service and grooming standards. }
\resumeItem{ Recognized for punctuality, grooming, and positive attitude under pressure. }
\resumeItem{ Collaborated with diverse teams to meet daily operational goals.}
\resumeItemListEnd
% \resumeSubheading
...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
	\small{
	\item \makebox[2.6cm][l]{\textbf{English}} - Fluent
	\item \makebox[2.6cm][l]{\textbf{Hindi}} - Fluent
	\item \makebox[2.6cm][l]{\textbf{Arabic}} - Conversational
	\item \makebox[2.6cm][l]{\textbf{Malayalam}} - Native Speaker
	\item \makebox[2.6cm][l]{\textbf{Tamil}} - Fluent
	\item \makebox[2.6cm][l]{\textbf{Kannada}} - Fluent
	\item \makebox[2.6cm][l]{\textbf{Telugu}} - Conversational
	\item \makebox[2.6cm][l]{\textbf{Urdu}} - Fluent
		}
\end{itemize}
