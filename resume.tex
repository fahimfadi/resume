...
\begin{minipage}[t]{0.84\textwidth}  % Adjusted width to fill space
	\begin{center}
		...
		\small{
			...
			\raisebox{-0.2\height}\faEnvelope\ \href{mailto:fahimfadi237@gmail.com}{\underline{fahimfadi2021@gmail.com}} $|$
...
\resumeSubHeadingListStart
\resumeSubheading
{Practo Technologies Pvt. Ltd}{Nov. 2025 -- Present}
{Customer Support Specialist}{Bengaluru, Karnataka}
\resumeItemListStart
\resumeItem{Demonstrated strong communication skills while assisting patients with appointments, queries, and service navigation.}
\resumeItem{Applied effective problem-solving abilities to resolve customer concerns quickly and efficiently.}
\resumeItem{Managed multiple tasks simultaneously in a fast-paced environment, ensuring smooth service delivery.}
\resumeItem{Exhibited empathy and professionalism while handling diverse customer interactions and sensitive situations.}
\resumeItemListEnd
\resumeSubHeadingListStart
\resumeSubheading
{Dominos Pizza}
