...
\begin{itemize}[leftmargin=0.15in, label={}, itemsep=1pt]
    \small{
        \item \makebox[3.2cm][l]{\textbf{English}} - Fluent
        \item \makebox[3.2cm][l]{\textbf{Hindi}} - Fluent
        \item \makebox[3.2cm][l]{\textbf{Arabic}} - Conversational
        \item \makebox[3.2cm][l]{\textbf{Malayalam}} - Native Speaker
        \item \makebox[3.2cm][l]{\textbf{Tamil}} - Fluent
        \item \makebox[3.2cm][l]{\textbf{Kannada}} - Fluent
        \item \makebox[3.2cm][l]{\textbf{Telugu}} - Conversational
        \item \makebox[3.2cm][l]{\textbf{Urdu}} - Fluent
    }
\end{itemize}
